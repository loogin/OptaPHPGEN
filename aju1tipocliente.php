 ...
 */
    ...
    class aju1tipocliente_ter1clientePage extends DetailPage
    {
        ...
        protected function setupFilterBuilder(FilterBuilder $filterBuilder, FixedKeysArray $columns)
        {
            ...
            $main_editor->SetHandlerName('filter_builder_aju1tipocliente_ter1cliente_idFilial_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('idFilial', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_aju1tipocliente_ter1cliente_idFilial_search');
            ...
            $main_editor->setMinimumInputLength(0);
            $main_editor->SetAllowNullValue(false);
            $main_editor->SetHandlerName('filter_builder_aju1tipocliente_ter1cliente_idTipoCliente_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('idTipoCliente', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_aju1tipocliente_ter1cliente_idTipoCliente_search');
            ...
            $main_editor->setMinimumInputLength(0);
            $main_editor->SetAllowNullValue(false);
            $main_editor->SetHandlerName('filter_builder_aju1tipocliente_ter1cliente_idRegimen_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('idRegimen', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_aju1tipocliente_ter1cliente_idRegimen_search');
            ...
            $main_editor->setMinimumInputLength(0);
            $main_editor->SetAllowNullValue(false);
            $main_editor->SetHandlerName('filter_builder_aju1tipocliente_ter1cliente_idAsesorComercial_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('idAsesorComercial', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_aju1tipocliente_ter1cliente_idAsesorComercial_search');
            ...
            $main_editor->setMinimumInputLength(0);
            $main_editor->SetAllowNullValue(false);
            $main_editor->SetHandlerName('filter_builder_aju1tipocliente_ter1cliente_idAliadoNegocios_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('idAliadoNegocios', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_aju1tipocliente_ter1cliente_idAliadoNegocios_search');
            ...
            $main_editor->setMinimumInputLength(0);
            $main_editor->SetAllowNullValue(false);
            $main_editor->SetHandlerName('filter_builder_aju1tipocliente_ter1cliente_idEstado_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('idEstado', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_aju1tipocliente_ter1cliente_idEstado_search');
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            $editColumn = new DynamicLookupEditColumn('Id Filial', 'idFilial', 'idFilial_identificacionFilial', 'edit_aju1tipocliente_ter1cliente_idFilial_search', $editor, $this->dataset, $lookupDataset, 'id', 'identificacionFilial', '');
            ...
            $editColumn = new DynamicLookupEditColumn('Id Tipo Cliente', 'idTipoCliente', 'idTipoCliente_tipoCliente', 'edit_aju1tipocliente_ter1cliente_idTipoCliente_search', $editor, $this->dataset, $lookupDataset, 'id', 'tipoCliente', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            ...
            $editColumn = new DynamicLookupEditColumn('Id Regimen', 'idRegimen', 'idRegimen_regimen', 'edit_aju1tipocliente_ter1cliente_idRegimen_search', $editor, $this->dataset, $lookupDataset, 'id', 'regimen', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            ...
            $editColumn = new DynamicLookupEditColumn('Id Asesor Comercial', 'idAsesorComercial', 'idAsesorComercial_idEmpleado', 'edit_aju1tipocliente_ter1cliente_idAsesorComercial_search', $editor, $this->dataset, $lookupDataset, 'id', 'idEmpleado', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            ...
            $editColumn = new DynamicLookupEditColumn('Id Aliado Negocios', 'idAliadoNegocios', 'idAliadoNegocios_identificacionAliado', 'edit_aju1tipocliente_ter1cliente_idAliadoNegocios_search', $editor, $this->dataset, $lookupDataset, 'id', 'identificacionAliado', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            ...
            $editColumn = new DynamicLookupEditColumn('Id Estado', 'idEstado', 'idEstado_estado', 'edit_aju1tipocliente_ter1cliente_idEstado_search', $editor, $this->dataset, $lookupDataset, 'id', 'estado', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
        ...
        protected function AddMultiEditColumns(Grid $grid)
        {
            ...
            $lookupDataset->setOrderByField('identificacionFilial', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Id Filial', 'idFilial', 'idFilial_identificacionFilial', 'multi_edit_aju1tipocliente_ter1cliente_idFilial_search', $editor, $this->dataset, $lookupDataset, 'id', 'identificacionFilial', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            ...
            $lookupDataset->setOrderByField('tipoCliente', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Id Tipo Cliente', 'idTipoCliente', 'idTipoCliente_tipoCliente', 'multi_edit_aju1tipocliente_ter1cliente_idTipoCliente_search', $editor, $this->dataset, $lookupDataset, 'id', 'tipoCliente', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddMultiEditColumn($editColumn);
            ...
            $lookupDataset->setOrderByField('regimen', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Id Regimen', 'idRegimen', 'idRegimen_regimen', 'multi_edit_aju1tipocliente_ter1cliente_idRegimen_search', $editor, $this->dataset, $lookupDataset, 'id', 'regimen', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddMultiEditColumn($editColumn);
            ...
            $lookupDataset->setOrderByField('idEmpleado', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Id Asesor Comercial', 'idAsesorComercial', 'idAsesorComercial_idEmpleado', 'multi_edit_aju1tipocliente_ter1cliente_idAsesorComercial_search', $editor, $this->dataset, $lookupDataset, 'id', 'idEmpleado', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddMultiEditColumn($editColumn);
            ...
            $lookupDataset->setOrderByField('identificacionAliado', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Id Aliado Negocios', 'idAliadoNegocios', 'idAliadoNegocios_identificacionAliado', 'multi_edit_aju1tipocliente_ter1cliente_idAliadoNegocios_search', $editor, $this->dataset, $lookupDataset, 'id', 'identificacionAliado', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddMultiEditColumn($editColumn);
            ...
            $lookupDataset->setOrderByField('estado', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Id Estado', 'idEstado', 'idEstado_estado', 'multi_edit_aju1tipocliente_ter1cliente_idEstado_search', $editor, $this->dataset, $lookupDataset, 'id', 'estado', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddMultiEditColumn($editColumn);
        ...
        protected function AddInsertColumns(Grid $grid)
        {
            ...
            $lookupDataset->setOrderByField('identificacionFilial', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Id Filial', 'idFilial', 'idFilial_identificacionFilial', 'insert_aju1tipocliente_ter1cliente_idFilial_search', $editor, $this->dataset, $lookupDataset, 'id', 'identificacionFilial', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            ...
            $lookupDataset->setOrderByField('tipoCliente', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Id Tipo Cliente', 'idTipoCliente', 'idTipoCliente_tipoCliente', 'insert_aju1tipocliente_ter1cliente_idTipoCliente_search', $editor, $this->dataset, $lookupDataset, 'id', 'tipoCliente', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddInsertColumn($editColumn);
            ...
            $lookupDataset->setOrderByField('regimen', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Id Regimen', 'idRegimen', 'idRegimen_regimen', 'insert_aju1tipocliente_ter1cliente_idRegimen_search', $editor, $this->dataset, $lookupDataset, 'id', 'regimen', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddInsertColumn($editColumn);
            ...
            $lookupDataset->setOrderByField('idEmpleado', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Id Asesor Comercial', 'idAsesorComercial', 'idAsesorComercial_idEmpleado', 'insert_aju1tipocliente_ter1cliente_idAsesorComercial_search', $editor, $this->dataset, $lookupDataset, 'id', 'idEmpleado', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddInsertColumn($editColumn);
            ...
            $lookupDataset->setOrderByField('identificacionAliado', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Id Aliado Negocios', 'idAliadoNegocios', 'idAliadoNegocios_identificacionAliado', 'insert_aju1tipocliente_ter1cliente_idAliadoNegocios_search', $editor, $this->dataset, $lookupDataset, 'id', 'identificacionAliado', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddInsertColumn($editColumn);
            ...
            $lookupDataset->setOrderByField('estado', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Id Estado', 'idEstado', 'idEstado_estado', 'insert_aju1tipocliente_ter1cliente_idEstado_search', $editor, $this->dataset, $lookupDataset, 'id', 'estado', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddInsertColumn($editColumn);
        ...
        protected function doRegisterHandlers() {
            ...
            $lookupDataset->setOrderByField('identificacionFilial', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'insert_aju1tipocliente_ter1cliente_idFilial_search', 'id', 'identificacionFilial', null, 20);
            ...
            $lookupDataset->setOrderByField('tipoCliente', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'insert_aju1tipocliente_ter1cliente_idTipoCliente_search', 'id', 'tipoCliente', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('regimen', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'insert_aju1tipocliente_ter1cliente_idRegimen_search', 'id', 'regimen', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('idEmpleado', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'insert_aju1tipocliente_ter1cliente_idAsesorComercial_search', 'id', 'idEmpleado', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('identificacionAliado', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'insert_aju1tipocliente_ter1cliente_idAliadoNegocios_search', 'id', 'identificacionAliado', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('estado', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'insert_aju1tipocliente_ter1cliente_idEstado_search', 'id', 'estado', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('identificacionFilial', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'filter_builder_aju1tipocliente_ter1cliente_idFilial_search', 'id', 'identificacionFilial', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('tipoCliente', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'filter_builder_aju1tipocliente_ter1cliente_idTipoCliente_search', 'id', 'tipoCliente', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('regimen', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'filter_builder_aju1tipocliente_ter1cliente_idRegimen_search', 'id', 'regimen', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('idEmpleado', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'filter_builder_aju1tipocliente_ter1cliente_idAsesorComercial_search', 'id', 'idEmpleado', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('identificacionAliado', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'filter_builder_aju1tipocliente_ter1cliente_idAliadoNegocios_search', 'id', 'identificacionAliado', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('estado', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'filter_builder_aju1tipocliente_ter1cliente_idEstado_search', 'id', 'estado', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('identificacionFilial', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'edit_aju1tipocliente_ter1cliente_idFilial_search', 'id', 'identificacionFilial', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('tipoCliente', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'edit_aju1tipocliente_ter1cliente_idTipoCliente_search', 'id', 'tipoCliente', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('regimen', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'edit_aju1tipocliente_ter1cliente_idRegimen_search', 'id', 'regimen', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('idEmpleado', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'edit_aju1tipocliente_ter1cliente_idAsesorComercial_search', 'id', 'idEmpleado', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('identificacionAliado', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'edit_aju1tipocliente_ter1cliente_idAliadoNegocios_search', 'id', 'identificacionAliado', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('estado', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'edit_aju1tipocliente_ter1cliente_idEstado_search', 'id', 'estado', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('identificacionFilial', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'multi_edit_aju1tipocliente_ter1cliente_idFilial_search', 'id', 'identificacionFilial', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('tipoCliente', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'multi_edit_aju1tipocliente_ter1cliente_idTipoCliente_search', 'id', 'tipoCliente', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('regimen', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'multi_edit_aju1tipocliente_ter1cliente_idRegimen_search', 'id', 'regimen', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('idEmpleado', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'multi_edit_aju1tipocliente_ter1cliente_idAsesorComercial_search', 'id', 'idEmpleado', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('identificacionAliado', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'multi_edit_aju1tipocliente_ter1cliente_idAliadoNegocios_search', 'id', 'identificacionAliado', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('estado', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'multi_edit_aju1tipocliente_ter1cliente_idEstado_search', 'id', 'estado', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
        }
    ...
    class aju1tipoclientePage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('Aju1tipocliente');
            $this->SetMenuLabel('Aju1tipocliente');
        ...
        protected function getFiltersColumns()
        {
            return array(
                new FilterColumn($this->dataset, 'id', 'id', 'Id'),
                new FilterColumn($this->dataset, 'tipoCliente', 'tipoCliente', 'Tipo Cliente'),
        ...
        protected function setupFilterBuilder(FilterBuilder $filterBuilder, FixedKeysArray $columns)
        {
            ...
            $main_editor = new TextEdit('tipocliente_edit');
            $main_editor->SetMaxLength(100);
        ...
        protected function AddFieldColumns(Grid $grid, $withDetails = true)
        {
            if (GetCurrentUserPermissionsForPage('aju1tipocliente.ter1cliente')->HasViewGrant() && $withDetails)
            {
            //
            // View column for aju1tipocliente_ter1cliente detail
            //
            $column = new DetailColumn(array('id'), 'aju1tipocliente.ter1cliente', 'aju1tipocliente_ter1cliente_handler', $this->dataset, 'Ter1cliente');
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            $grid->AddViewColumn($column);
            }
            ...
            // View column for tipoCliente field
            //
            $column = new TextViewColumn('tipoCliente', 'tipoCliente', 'Tipo Cliente', $this->dataset);
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            $grid->AddViewColumn($column);
        ...
        {
            //
            // Edit column for tipoCliente field
            //
            $editor = new TextEdit('tipocliente_edit');
            $editor->SetMaxLength(100);
            $editColumn = new CustomEditColumn('Tipo Cliente', 'tipoCliente', $editor, $this->dataset);
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
        ...
        protected function doRegisterHandlers() {
            $detailPage = new aju1tipocliente_ter1clientePage('aju1tipocliente_ter1cliente', $this, array('idTipoCliente'), array('id'), $this->GetForeignKeyFields(), $this->CreateMasterDetailRecordGrid(), $this->dataset, GetCurrentUserPermissionsForPage('aju1tipocliente.ter1cliente'), 'UTF-8');
            $detailPage->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource('aju1tipocliente.ter1cliente'));
            $detailPage->SetHttpHandlerName('aju1tipocliente_ter1cliente_handler');
            $handler = new PageHTTPHandler('aju1tipocliente_ter1cliente_handler', $detailPage);
            GetApplication()->RegisterHTTPHandler($handler);
    ...
    try
    {
        $Page = new aju1tipoclientePage("aju1tipocliente", "aju1tipocliente.php", GetCurrentUserPermissionsForPage("aju1tipocliente"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("aju1tipocliente"));

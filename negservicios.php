 ...
 */
    ...
    class negserviciosPage extends Page
    {
        ...
        protected function setupFilterBuilder(FilterBuilder $filterBuilder, FixedKeysArray $columns)
        {
            ...
            $main_editor->SetHandlerName('filter_builder_negservicios_idCat_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('idCat', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_negservicios_idCat_search');
            ...
            $main_editor->setMinimumInputLength(0);
            $main_editor->SetAllowNullValue(false);
            $main_editor->SetHandlerName('filter_builder_negservicios_idGrupoInventario_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('idGrupoInventario', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_negservicios_idGrupoInventario_search');
            ...
            $main_editor->setMinimumInputLength(0);
            $main_editor->SetAllowNullValue(false);
            $main_editor->SetHandlerName('filter_builder_negservicios_idimpuesto_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('idimpuesto', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_negservicios_idimpuesto_search');
            ...
            $main_editor->setMinimumInputLength(0);
            $main_editor->SetAllowNullValue(false);
            $main_editor->SetHandlerName('filter_builder_negservicios_idUnidadMedida_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('idUnidadMedida', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_negservicios_idUnidadMedida_search');
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            $editColumn = new DynamicLookupEditColumn('Id Cat', 'idCat', 'idCat_nombreCatalogo', 'edit_negservicios_idCat_search', $editor, $this->dataset, $lookupDataset, 'id', 'nombreCatalogo', '');
            ...
            $editColumn = new DynamicLookupEditColumn('Id Grupo Inventario', 'idGrupoInventario', 'idGrupoInventario_grupoInventarios', 'edit_negservicios_idGrupoInventario_search', $editor, $this->dataset, $lookupDataset, 'id', 'grupoInventarios', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            ...
            $editColumn = new DynamicLookupEditColumn('Idimpuesto', 'idimpuesto', 'idimpuesto_nombreImpuesto', 'edit_negservicios_idimpuesto_search', $editor, $this->dataset, $lookupDataset, 'id', 'nombreImpuesto', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            ...
            $editColumn = new DynamicLookupEditColumn('Id Unidad Medida', 'idUnidadMedida', 'idUnidadMedida_unidadMedida', 'edit_negservicios_idUnidadMedida_search', $editor, $this->dataset, $lookupDataset, 'id', 'unidadMedida', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
        ...
        protected function AddMultiEditColumns(Grid $grid)
        {
            ...
            $lookupDataset->setOrderByField('nombreCatalogo', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Id Cat', 'idCat', 'idCat_nombreCatalogo', 'multi_edit_negservicios_idCat_search', $editor, $this->dataset, $lookupDataset, 'id', 'nombreCatalogo', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            ...
            $lookupDataset->setOrderByField('grupoInventarios', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Id Grupo Inventario', 'idGrupoInventario', 'idGrupoInventario_grupoInventarios', 'multi_edit_negservicios_idGrupoInventario_search', $editor, $this->dataset, $lookupDataset, 'id', 'grupoInventarios', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddMultiEditColumn($editColumn);
            ...
            $lookupDataset->setOrderByField('nombreImpuesto', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Idimpuesto', 'idimpuesto', 'idimpuesto_nombreImpuesto', 'multi_edit_negservicios_idimpuesto_search', $editor, $this->dataset, $lookupDataset, 'id', 'nombreImpuesto', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddMultiEditColumn($editColumn);
            ...
            $lookupDataset->setOrderByField('unidadMedida', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Id Unidad Medida', 'idUnidadMedida', 'idUnidadMedida_unidadMedida', 'multi_edit_negservicios_idUnidadMedida_search', $editor, $this->dataset, $lookupDataset, 'id', 'unidadMedida', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddMultiEditColumn($editColumn);
        ...
        protected function AddInsertColumns(Grid $grid)
        {
            ...
            $lookupDataset->setOrderByField('nombreCatalogo', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Id Cat', 'idCat', 'idCat_nombreCatalogo', 'insert_negservicios_idCat_search', $editor, $this->dataset, $lookupDataset, 'id', 'nombreCatalogo', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            ...
            $lookupDataset->setOrderByField('grupoInventarios', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Id Grupo Inventario', 'idGrupoInventario', 'idGrupoInventario_grupoInventarios', 'insert_negservicios_idGrupoInventario_search', $editor, $this->dataset, $lookupDataset, 'id', 'grupoInventarios', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddInsertColumn($editColumn);
            ...
            $lookupDataset->setOrderByField('nombreImpuesto', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Idimpuesto', 'idimpuesto', 'idimpuesto_nombreImpuesto', 'insert_negservicios_idimpuesto_search', $editor, $this->dataset, $lookupDataset, 'id', 'nombreImpuesto', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddInsertColumn($editColumn);
            ...
            $lookupDataset->setOrderByField('unidadMedida', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Id Unidad Medida', 'idUnidadMedida', 'idUnidadMedida_unidadMedida', 'insert_negservicios_idUnidadMedida_search', $editor, $this->dataset, $lookupDataset, 'id', 'unidadMedida', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddInsertColumn($editColumn);
        ...
        protected function doRegisterHandlers() {
            ...
            $lookupDataset->setOrderByField('nombreCatalogo', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'insert_negservicios_idCat_search', 'id', 'nombreCatalogo', null, 20);
            ...
            $lookupDataset->setOrderByField('grupoInventarios', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'insert_negservicios_idGrupoInventario_search', 'id', 'grupoInventarios', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('nombreImpuesto', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'insert_negservicios_idimpuesto_search', 'id', 'nombreImpuesto', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('unidadMedida', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'insert_negservicios_idUnidadMedida_search', 'id', 'unidadMedida', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('nombreCatalogo', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'filter_builder_negservicios_idCat_search', 'id', 'nombreCatalogo', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('grupoInventarios', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'filter_builder_negservicios_idGrupoInventario_search', 'id', 'grupoInventarios', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('nombreImpuesto', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'filter_builder_negservicios_idimpuesto_search', 'id', 'nombreImpuesto', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('unidadMedida', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'filter_builder_negservicios_idUnidadMedida_search', 'id', 'unidadMedida', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('nombreCatalogo', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'edit_negservicios_idCat_search', 'id', 'nombreCatalogo', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('grupoInventarios', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'edit_negservicios_idGrupoInventario_search', 'id', 'grupoInventarios', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('nombreImpuesto', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'edit_negservicios_idimpuesto_search', 'id', 'nombreImpuesto', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('unidadMedida', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'edit_negservicios_idUnidadMedida_search', 'id', 'unidadMedida', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('nombreCatalogo', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'multi_edit_negservicios_idCat_search', 'id', 'nombreCatalogo', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('grupoInventarios', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'multi_edit_negservicios_idGrupoInventario_search', 'id', 'grupoInventarios', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('nombreImpuesto', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'multi_edit_negservicios_idimpuesto_search', 'id', 'nombreImpuesto', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('unidadMedida', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'multi_edit_negservicios_idUnidadMedida_search', 'id', 'unidadMedida', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
        }
    ...
    try
    {
        $Page = new negserviciosPage("negservicios", "negservicios.php", GetCurrentUserPermissionsForPage("negservicios"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("negservicios"));

 ...
 */
    ...
    class aju1formatoscontratoPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('Aju1formatoscontrato');
            $this->SetMenuLabel('Aju1formatoscontrato');
    
            $this->dataset = new TableDataset(
                MySqlIConnectionFactory::getInstance(),
                GetConnectionOptions(),
                '`aju1formatoscontrato`');
            $this->dataset->addFields(
                array(
                    new IntegerField('id', true, true, true),
                    new StringField('NombreFormato', true),
                    new StringField('formatoHTML', true),
        ...
        protected function getFiltersColumns()
        {
            return array(
                ...
                new FilterColumn($this->dataset, 'NombreFormato', 'NombreFormato', 'Nombre Formato'),
                new FilterColumn($this->dataset, 'formatoHTML', 'formatoHTML', 'Formato HTML'),
        ...
        protected function setupQuickFilter(QuickFilter $quickFilter, FixedKeysArray $columns)
        {
            $quickFilter
                ...
                ->addColumn($columns['NombreFormato'])
                ->addColumn($columns['formatoHTML'])
        ...
        protected function setupFilterBuilder(FilterBuilder $filterBuilder, FixedKeysArray $columns)
        {
            ...
            $main_editor = new TextEdit('nombreformato_edit');
            $main_editor->SetMaxLength(100);
            
            $filterBuilder->addColumn(
                $columns['NombreFormato'],
                array(
                    FilterConditionOperator::EQUALS => $main_editor,
                    FilterConditionOperator::DOES_NOT_EQUAL => $main_editor,
                    FilterConditionOperator::IS_GREATER_THAN => $main_editor,
            ...
            $main_editor = new TextEdit('formatoHTML');
        ...
        protected function AddFieldColumns(Grid $grid, $withDetails = true)
        {
            ...
            //
            // View column for NombreFormato field
            //
            $column = new TextViewColumn('NombreFormato', 'NombreFormato', 'Nombre Formato', $this->dataset);
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            $grid->AddViewColumn($column);
            //
            // View column for formatoHTML field
            //
            $column = new TextViewColumn('formatoHTML', 'formatoHTML', 'Formato HTML', $this->dataset);
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            $grid->AddViewColumn($column);
        ...
        {
            //
            // Edit column for NombreFormato field
            //
            $editor = new TextEdit('nombreformato_edit');
            $editor->SetMaxLength(100);
            $editColumn = new CustomEditColumn('Nombre Formato', 'NombreFormato', $editor, $this->dataset);
            ...
            //
            // Edit column for formatoHTML field
            //
            $editor = new TextAreaEdit('formatohtml_edit', 50, 8);
            $editColumn = new CustomEditColumn('Formato HTML', 'formatoHTML', $editor, $this->dataset);
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
    ...
    try
    {
        $Page = new aju1formatoscontratoPage("aju1formatoscontrato", "aju1formatoscontrato.php", GetCurrentUserPermissionsForPage("aju1formatoscontrato"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("aju1formatoscontrato"));

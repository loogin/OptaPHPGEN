 ...
 */
    ...
    class aju1regimenPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('Aju1regimen');
            $this->SetMenuLabel('Aju1regimen');
        ...
        protected function getFiltersColumns()
        {
            return array(
                ...
                new FilterColumn($this->dataset, 'regimen', 'regimen', 'Régimen'),
        ...
        protected function setupFilterBuilder(FilterBuilder $filterBuilder, FixedKeysArray $columns)
        {
            ...
            $main_editor = new TextEdit('regimen_edit');
        ...
        protected function AddFieldColumns(Grid $grid, $withDetails = true)
        {
            ...
            //
            $column = new TextViewColumn('regimen', 'regimen', 'Régimen', $this->dataset);
            $column->SetOrderable(true);
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            //
            $editor = new TextEdit('regimen_edit');
            $editor->SetMaxLength(100);
            $editColumn = new CustomEditColumn('Régimen', 'regimen', $editor, $this->dataset);
    ...
    try
    {
        $Page = new aju1regimenPage("aju1regimen", "aju1regimen.php", GetCurrentUserPermissionsForPage("aju1regimen"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("aju1regimen"));

 ...
 */
    ...
    class neg1negociacion_clientelimitescontratoPage extends DetailPage
    {
        ...
        protected function setupFilterBuilder(FilterBuilder $filterBuilder, FixedKeysArray $columns)
        {
            ...
            $main_editor->SetHandlerName('filter_builder_neg1negociacion_clientelimitescontrato_idNegociacion_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('idNegociacion', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_neg1negociacion_clientelimitescontrato_idNegociacion_search');
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            $editColumn = new DynamicLookupEditColumn('Id Negociacion', 'idNegociacion', 'idNegociacion_nombreCatalogo', 'edit_neg1negociacion_clientelimitescontrato_idNegociacion_search', $editor, $this->dataset, $lookupDataset, 'id', 'nombreCatalogo', '');
        ...
        protected function AddMultiEditColumns(Grid $grid)
        {
            ...
            $lookupDataset->setOrderByField('nombreCatalogo', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Id Negociacion', 'idNegociacion', 'idNegociacion_nombreCatalogo', 'multi_edit_neg1negociacion_clientelimitescontrato_idNegociacion_search', $editor, $this->dataset, $lookupDataset, 'id', 'nombreCatalogo', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
        ...
        protected function AddInsertColumns(Grid $grid)
        {
            ...
            $lookupDataset->setOrderByField('nombreCatalogo', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Id Negociacion', 'idNegociacion', 'idNegociacion_nombreCatalogo', 'insert_neg1negociacion_clientelimitescontrato_idNegociacion_search', $editor, $this->dataset, $lookupDataset, 'id', 'nombreCatalogo', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
        ...
        protected function doRegisterHandlers() {
            ...
            $lookupDataset->setOrderByField('nombreCatalogo', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'insert_neg1negociacion_clientelimitescontrato_idNegociacion_search', 'id', 'nombreCatalogo', null, 20);
            ...
            $lookupDataset->setOrderByField('nombreCatalogo', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'filter_builder_neg1negociacion_clientelimitescontrato_idNegociacion_search', 'id', 'nombreCatalogo', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('nombreCatalogo', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'edit_neg1negociacion_clientelimitescontrato_idNegociacion_search', 'id', 'nombreCatalogo', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('nombreCatalogo', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'multi_edit_neg1negociacion_clientelimitescontrato_idNegociacion_search', 'id', 'nombreCatalogo', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
        }
    ...
    class neg1negociacion_negserviciosPage extends DetailPage
    {
        protected function DoBeforeCreate()
        {
        ...
        protected function setupFilterBuilder(FilterBuilder $filterBuilder, FixedKeysArray $columns)
        {
            ...
            $main_editor->setMinimumInputLength(0);
            $main_editor->SetAllowNullValue(false);
            $main_editor->SetHandlerName('filter_builder_neg1negociacion_negservicios_idCat_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('idCat', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_neg1negociacion_negservicios_idCat_search');
            ...
            $main_editor->setMinimumInputLength(0);
            $main_editor->SetAllowNullValue(false);
            $main_editor->SetHandlerName('filter_builder_neg1negociacion_negservicios_idGrupoInventario_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('idGrupoInventario', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_neg1negociacion_negservicios_idGrupoInventario_search');
            ...
            $main_editor->setMinimumInputLength(0);
            $main_editor->SetAllowNullValue(false);
            $main_editor->SetHandlerName('filter_builder_neg1negociacion_negservicios_idimpuesto_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('idimpuesto', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_neg1negociacion_negservicios_idimpuesto_search');
            ...
            $main_editor->setMinimumInputLength(0);
            $main_editor->SetAllowNullValue(false);
            $main_editor->SetHandlerName('filter_builder_neg1negociacion_negservicios_idUnidadMedida_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('idUnidadMedida', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_neg1negociacion_negservicios_idUnidadMedida_search');
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            $lookupDataset->setOrderByField('nombreCatalogo', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Id Cat', 'idCat', 'idCat_nombreCatalogo', 'edit_neg1negociacion_negservicios_idCat_search', $editor, $this->dataset, $lookupDataset, 'id', 'nombreCatalogo', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            ...
            $editColumn = new DynamicLookupEditColumn('Id Grupo Inventario', 'idGrupoInventario', 'idGrupoInventario_grupoInventarios', 'edit_neg1negociacion_negservicios_idGrupoInventario_search', $editor, $this->dataset, $lookupDataset, 'id', 'grupoInventarios', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            ...
            $editColumn = new DynamicLookupEditColumn('Idimpuesto', 'idimpuesto', 'idimpuesto_nombreImpuesto', 'edit_neg1negociacion_negservicios_idimpuesto_search', $editor, $this->dataset, $lookupDataset, 'id', 'nombreImpuesto', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            ...
            $editColumn = new DynamicLookupEditColumn('Id Unidad Medida', 'idUnidadMedida', 'idUnidadMedida_unidadMedida', 'edit_neg1negociacion_negservicios_idUnidadMedida_search', $editor, $this->dataset, $lookupDataset, 'id', 'unidadMedida', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
        ...
        protected function AddMultiEditColumns(Grid $grid)
        {
            ...
            $lookupDataset->setOrderByField('nombreCatalogo', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Id Cat', 'idCat', 'idCat_nombreCatalogo', 'multi_edit_neg1negociacion_negservicios_idCat_search', $editor, $this->dataset, $lookupDataset, 'id', 'nombreCatalogo', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddMultiEditColumn($editColumn);
            ...
            $lookupDataset->setOrderByField('grupoInventarios', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Id Grupo Inventario', 'idGrupoInventario', 'idGrupoInventario_grupoInventarios', 'multi_edit_neg1negociacion_negservicios_idGrupoInventario_search', $editor, $this->dataset, $lookupDataset, 'id', 'grupoInventarios', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddMultiEditColumn($editColumn);
            ...
            $lookupDataset->setOrderByField('nombreImpuesto', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Idimpuesto', 'idimpuesto', 'idimpuesto_nombreImpuesto', 'multi_edit_neg1negociacion_negservicios_idimpuesto_search', $editor, $this->dataset, $lookupDataset, 'id', 'nombreImpuesto', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddMultiEditColumn($editColumn);
            ...
            $lookupDataset->setOrderByField('unidadMedida', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Id Unidad Medida', 'idUnidadMedida', 'idUnidadMedida_unidadMedida', 'multi_edit_neg1negociacion_negservicios_idUnidadMedida_search', $editor, $this->dataset, $lookupDataset, 'id', 'unidadMedida', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddMultiEditColumn($editColumn);
        ...
        protected function AddInsertColumns(Grid $grid)
        {
            ...
            $lookupDataset->setOrderByField('nombreCatalogo', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Id Cat', 'idCat', 'idCat_nombreCatalogo', 'insert_neg1negociacion_negservicios_idCat_search', $editor, $this->dataset, $lookupDataset, 'id', 'nombreCatalogo', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddInsertColumn($editColumn);
            ...
            $lookupDataset->setOrderByField('grupoInventarios', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Id Grupo Inventario', 'idGrupoInventario', 'idGrupoInventario_grupoInventarios', 'insert_neg1negociacion_negservicios_idGrupoInventario_search', $editor, $this->dataset, $lookupDataset, 'id', 'grupoInventarios', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddInsertColumn($editColumn);
            ...
            $lookupDataset->setOrderByField('nombreImpuesto', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Idimpuesto', 'idimpuesto', 'idimpuesto_nombreImpuesto', 'insert_neg1negociacion_negservicios_idimpuesto_search', $editor, $this->dataset, $lookupDataset, 'id', 'nombreImpuesto', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddInsertColumn($editColumn);
            ...
            $lookupDataset->setOrderByField('unidadMedida', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Id Unidad Medida', 'idUnidadMedida', 'idUnidadMedida_unidadMedida', 'insert_neg1negociacion_negservicios_idUnidadMedida_search', $editor, $this->dataset, $lookupDataset, 'id', 'unidadMedida', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddInsertColumn($editColumn);
        ...
        protected function doRegisterHandlers() {
            ...
            $lookupDataset->setOrderByField('nombreCatalogo', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'insert_neg1negociacion_negservicios_idCat_search', 'id', 'nombreCatalogo', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('grupoInventarios', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'insert_neg1negociacion_negservicios_idGrupoInventario_search', 'id', 'grupoInventarios', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('nombreImpuesto', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'insert_neg1negociacion_negservicios_idimpuesto_search', 'id', 'nombreImpuesto', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('unidadMedida', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'insert_neg1negociacion_negservicios_idUnidadMedida_search', 'id', 'unidadMedida', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('nombreCatalogo', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'filter_builder_neg1negociacion_negservicios_idCat_search', 'id', 'nombreCatalogo', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('grupoInventarios', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'filter_builder_neg1negociacion_negservicios_idGrupoInventario_search', 'id', 'grupoInventarios', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('nombreImpuesto', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'filter_builder_neg1negociacion_negservicios_idimpuesto_search', 'id', 'nombreImpuesto', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('unidadMedida', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'filter_builder_neg1negociacion_negservicios_idUnidadMedida_search', 'id', 'unidadMedida', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('nombreCatalogo', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'edit_neg1negociacion_negservicios_idCat_search', 'id', 'nombreCatalogo', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('grupoInventarios', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'edit_neg1negociacion_negservicios_idGrupoInventario_search', 'id', 'grupoInventarios', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('nombreImpuesto', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'edit_neg1negociacion_negservicios_idimpuesto_search', 'id', 'nombreImpuesto', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('unidadMedida', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'edit_neg1negociacion_negservicios_idUnidadMedida_search', 'id', 'unidadMedida', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('nombreCatalogo', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'multi_edit_neg1negociacion_negservicios_idCat_search', 'id', 'nombreCatalogo', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('grupoInventarios', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'multi_edit_neg1negociacion_negservicios_idGrupoInventario_search', 'id', 'grupoInventarios', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('nombreImpuesto', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'multi_edit_neg1negociacion_negservicios_idimpuesto_search', 'id', 'nombreImpuesto', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('unidadMedida', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'multi_edit_neg1negociacion_negservicios_idUnidadMedida_search', 'id', 'unidadMedida', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
        }
    ...
    class neg1negociacionPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('Neg1negociacion');
            $this->SetMenuLabel('&#x2714; NEGOCIACIÓN');
        ...
        protected function getFiltersColumns()
        {
            return array(
                new FilterColumn($this->dataset, 'id', 'id', 'Id'),
                new FilterColumn($this->dataset, 'nombreCatalogo', 'nombreCatalogo', 'Nombre Catalogo'),
                new FilterColumn($this->dataset, 'fechaInicioVigencia', 'fechaInicioVigencia', 'Fecha Inicio Vigencia'),
                new FilterColumn($this->dataset, 'fechaFinVigencia', 'fechaFinVigencia', 'Fecha Fin Vigencia'),
                new FilterColumn($this->dataset, 'idEstado', 'idEstado', 'Id Estado'),
                new FilterColumn($this->dataset, 'usuarioRegistra', 'usuarioRegistra', 'Usuario Registra'),
                new FilterColumn($this->dataset, 'fecharegistra', 'fecharegistra', 'Fecharegistra')
            );
        }
        ...
        protected function setupQuickFilter(QuickFilter $quickFilter, FixedKeysArray $columns)
        {
            $quickFilter
                ->addColumn($columns['id'])
                ->addColumn($columns['nombreCatalogo'])
                ->addColumn($columns['fechaInicioVigencia'])
                ->addColumn($columns['fechaFinVigencia'])
        ...
        {
            $columnFilter
                ->setOptionsFor('fechaInicioVigencia')
                ->setOptionsFor('fechaFinVigencia')
                ->setOptionsFor('fecharegistra');
        }
        ...
        protected function setupFilterBuilder(FilterBuilder $filterBuilder, FixedKeysArray $columns)
        {
            ...
            $main_editor = new TextEdit('nombrecatalogo_edit');
            $main_editor->SetMaxLength(100);
            
            $filterBuilder->addColumn(
                $columns['nombreCatalogo'],
                array(
                    FilterConditionOperator::EQUALS => $main_editor,
                    FilterConditionOperator::DOES_NOT_EQUAL => $main_editor,
                    FilterConditionOperator::IS_GREATER_THAN => $main_editor,
            ...
            $main_editor = new DateTimeEdit('fechainiciovigencia_edit', false, 'Y-m-d');
            
            $filterBuilder->addColumn(
                $columns['fechaInicioVigencia'],
                array(
                    FilterConditionOperator::EQUALS => $main_editor,
                    FilterConditionOperator::DOES_NOT_EQUAL => $main_editor,
                    FilterConditionOperator::IS_GREATER_THAN => $main_editor,
            ...
            $main_editor = new DateTimeEdit('fechafinvigencia_edit', false, 'Y-m-d');
            
            $filterBuilder->addColumn(
                $columns['fechaFinVigencia'],
                array(
                    FilterConditionOperator::EQUALS => $main_editor,
                    FilterConditionOperator::DOES_NOT_EQUAL => $main_editor,
                    FilterConditionOperator::IS_GREATER_THAN => $main_editor,
        ...
        protected function AddFieldColumns(Grid $grid, $withDetails = true)
        {
            if (GetCurrentUserPermissionsForPage('neg1negociacion.clientelimitescontrato')->HasViewGrant() && $withDetails)
            {
            //
            // View column for neg1negociacion_clientelimitescontrato detail
            //
            $column = new DetailColumn(array('id'), 'neg1negociacion.clientelimitescontrato', 'neg1negociacion_clientelimitescontrato_handler', $this->dataset, 'Clientelimitescontrato');
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            $grid->AddViewColumn($column);
            }
            
            if (GetCurrentUserPermissionsForPage('neg1negociacion.negservicios')->HasViewGrant() && $withDetails)
            {
            //
            // View column for neg1negociacion_negservicios detail
            //
            $column = new DetailColumn(array('id'), 'neg1negociacion.negservicios', 'neg1negociacion_negservicios_handler', $this->dataset, 'Negservicios');
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            $grid->AddViewColumn($column);
            }
            ...
            // View column for nombreCatalogo field
            //
            $column = new TextViewColumn('nombreCatalogo', 'nombreCatalogo', 'Nombre Catalogo', $this->dataset);
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            $grid->AddViewColumn($column);
            //
            // View column for fechaInicioVigencia field
            //
            $column = new DateTimeViewColumn('fechaInicioVigencia', 'fechaInicioVigencia', 'Fecha Inicio Vigencia', $this->dataset);
            $column->SetOrderable(true);
            $column->SetDateTimeFormat('Y-m-d');
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            $grid->AddViewColumn($column);
            //
            // View column for fechaFinVigencia field
            //
            $column = new DateTimeViewColumn('fechaFinVigencia', 'fechaFinVigencia', 'Fecha Fin Vigencia', $this->dataset);
            $column->SetOrderable(true);
            $column->SetDateTimeFormat('Y-m-d');
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            $grid->AddViewColumn($column);
            ...
            // View column for fecharegistra field
            //
            $column = new DateTimeViewColumn('fecharegistra', 'fecharegistra', 'Fecharegistra', $this->dataset);
            $column->SetOrderable(true);
            $column->SetDateTimeFormat('Y-m-d H:i:s');
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            $grid->AddViewColumn($column);
        ...
        {
            //
            // Edit column for nombreCatalogo field
            //
            $editor = new TextEdit('nombrecatalogo_edit');
            $editor->SetMaxLength(100);
            $editColumn = new CustomEditColumn('Nombre Catalogo', 'nombreCatalogo', $editor, $this->dataset);
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            ...
            //
            // Edit column for fechaInicioVigencia field
            //
            $editor = new DateTimeEdit('fechainiciovigencia_edit', false, 'Y-m-d');
            $editColumn = new CustomEditColumn('Fecha Inicio Vigencia', 'fechaInicioVigencia', $editor, $this->dataset);
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            ...
            //
            // Edit column for fechaFinVigencia field
            //
            $editor = new DateTimeEdit('fechafinvigencia_edit', false, 'Y-m-d');
            $editColumn = new CustomEditColumn('Fecha Fin Vigencia', 'fechaFinVigencia', $editor, $this->dataset);
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            ...
            //
            $editor = new DateTimeEdit('fecharegistra_edit', false, 'Y-m-d H:i:s');
            $editColumn = new CustomEditColumn('Fecharegistra', 'fecharegistra', $editor, $this->dataset);
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
        ...
        protected function doRegisterHandlers() {
            $detailPage = new neg1negociacion_clientelimitescontratoPage('neg1negociacion_clientelimitescontrato', $this, array('idNegociacion'), array('id'), $this->GetForeignKeyFields(), $this->CreateMasterDetailRecordGrid(), $this->dataset, GetCurrentUserPermissionsForPage('neg1negociacion.clientelimitescontrato'), 'UTF-8');
            $detailPage->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource('neg1negociacion.clientelimitescontrato'));
            $detailPage->SetHttpHandlerName('neg1negociacion_clientelimitescontrato_handler');
            $handler = new PageHTTPHandler('neg1negociacion_clientelimitescontrato_handler', $detailPage);
            GetApplication()->RegisterHTTPHandler($handler);
            
            $detailPage = new neg1negociacion_negserviciosPage('neg1negociacion_negservicios', $this, array('idCat'), array('id'), $this->GetForeignKeyFields(), $this->CreateMasterDetailRecordGrid(), $this->dataset, GetCurrentUserPermissionsForPage('neg1negociacion.negservicios'), 'UTF-8');
            $detailPage->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource('neg1negociacion.negservicios'));
            $detailPage->SetHttpHandlerName('neg1negociacion_negservicios_handler');
            $handler = new PageHTTPHandler('neg1negociacion_negservicios_handler', $detailPage);
            GetApplication()->RegisterHTTPHandler($handler);
    ...
    try
    {
        $Page = new neg1negociacionPage("neg1negociacion", "neg1negociacion.php", GetCurrentUserPermissionsForPage("neg1negociacion"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("neg1negociacion"));

 ...
 */
    ...
    class ter1aliadonegocio_ter1clientePage extends DetailPage
    {
        ...
        protected function setupFilterBuilder(FilterBuilder $filterBuilder, FixedKeysArray $columns)
        {
            ...
            $main_editor->SetHandlerName('filter_builder_ter1aliadonegocio_ter1cliente_idFilial_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('idFilial', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_ter1aliadonegocio_ter1cliente_idFilial_search');
            ...
            $main_editor->setMinimumInputLength(0);
            $main_editor->SetAllowNullValue(false);
            $main_editor->SetHandlerName('filter_builder_ter1aliadonegocio_ter1cliente_idTipoCliente_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('idTipoCliente', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_ter1aliadonegocio_ter1cliente_idTipoCliente_search');
            ...
            $main_editor->setMinimumInputLength(0);
            $main_editor->SetAllowNullValue(false);
            $main_editor->SetHandlerName('filter_builder_ter1aliadonegocio_ter1cliente_idRegimen_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('idRegimen', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_ter1aliadonegocio_ter1cliente_idRegimen_search');
            ...
            $main_editor->setMinimumInputLength(0);
            $main_editor->SetAllowNullValue(false);
            $main_editor->SetHandlerName('filter_builder_ter1aliadonegocio_ter1cliente_idAsesorComercial_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('idAsesorComercial', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_ter1aliadonegocio_ter1cliente_idAsesorComercial_search');
            ...
            $main_editor->setMinimumInputLength(0);
            $main_editor->SetAllowNullValue(false);
            $main_editor->SetHandlerName('filter_builder_ter1aliadonegocio_ter1cliente_idAliadoNegocios_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('idAliadoNegocios', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_ter1aliadonegocio_ter1cliente_idAliadoNegocios_search');
            ...
            $main_editor->setMinimumInputLength(0);
            $main_editor->SetAllowNullValue(false);
            $main_editor->SetHandlerName('filter_builder_ter1aliadonegocio_ter1cliente_idEstado_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('idEstado', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_ter1aliadonegocio_ter1cliente_idEstado_search');
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            $editColumn = new DynamicLookupEditColumn('Id Filial', 'idFilial', 'idFilial_identificacionFilial', 'edit_ter1aliadonegocio_ter1cliente_idFilial_search', $editor, $this->dataset, $lookupDataset, 'id', 'identificacionFilial', '');
            ...
            $editColumn = new DynamicLookupEditColumn('Id Tipo Cliente', 'idTipoCliente', 'idTipoCliente_tipoCliente', 'edit_ter1aliadonegocio_ter1cliente_idTipoCliente_search', $editor, $this->dataset, $lookupDataset, 'id', 'tipoCliente', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            ...
            $editColumn = new DynamicLookupEditColumn('Id Regimen', 'idRegimen', 'idRegimen_regimen', 'edit_ter1aliadonegocio_ter1cliente_idRegimen_search', $editor, $this->dataset, $lookupDataset, 'id', 'regimen', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            ...
            $editColumn = new DynamicLookupEditColumn('Id Asesor Comercial', 'idAsesorComercial', 'idAsesorComercial_idEmpleado', 'edit_ter1aliadonegocio_ter1cliente_idAsesorComercial_search', $editor, $this->dataset, $lookupDataset, 'id', 'idEmpleado', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            ...
            $editColumn = new DynamicLookupEditColumn('Id Aliado Negocios', 'idAliadoNegocios', 'idAliadoNegocios_identificacionAliado', 'edit_ter1aliadonegocio_ter1cliente_idAliadoNegocios_search', $editor, $this->dataset, $lookupDataset, 'id', 'identificacionAliado', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            ...
            $editColumn = new DynamicLookupEditColumn('Id Estado', 'idEstado', 'idEstado_estado', 'edit_ter1aliadonegocio_ter1cliente_idEstado_search', $editor, $this->dataset, $lookupDataset, 'id', 'estado', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
        ...
        protected function AddMultiEditColumns(Grid $grid)
        {
            ...
            $lookupDataset->setOrderByField('identificacionFilial', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Id Filial', 'idFilial', 'idFilial_identificacionFilial', 'multi_edit_ter1aliadonegocio_ter1cliente_idFilial_search', $editor, $this->dataset, $lookupDataset, 'id', 'identificacionFilial', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            ...
            $lookupDataset->setOrderByField('tipoCliente', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Id Tipo Cliente', 'idTipoCliente', 'idTipoCliente_tipoCliente', 'multi_edit_ter1aliadonegocio_ter1cliente_idTipoCliente_search', $editor, $this->dataset, $lookupDataset, 'id', 'tipoCliente', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddMultiEditColumn($editColumn);
            ...
            $lookupDataset->setOrderByField('regimen', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Id Regimen', 'idRegimen', 'idRegimen_regimen', 'multi_edit_ter1aliadonegocio_ter1cliente_idRegimen_search', $editor, $this->dataset, $lookupDataset, 'id', 'regimen', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddMultiEditColumn($editColumn);
            ...
            $lookupDataset->setOrderByField('idEmpleado', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Id Asesor Comercial', 'idAsesorComercial', 'idAsesorComercial_idEmpleado', 'multi_edit_ter1aliadonegocio_ter1cliente_idAsesorComercial_search', $editor, $this->dataset, $lookupDataset, 'id', 'idEmpleado', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddMultiEditColumn($editColumn);
            ...
            $lookupDataset->setOrderByField('identificacionAliado', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Id Aliado Negocios', 'idAliadoNegocios', 'idAliadoNegocios_identificacionAliado', 'multi_edit_ter1aliadonegocio_ter1cliente_idAliadoNegocios_search', $editor, $this->dataset, $lookupDataset, 'id', 'identificacionAliado', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddMultiEditColumn($editColumn);
            ...
            $lookupDataset->setOrderByField('estado', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Id Estado', 'idEstado', 'idEstado_estado', 'multi_edit_ter1aliadonegocio_ter1cliente_idEstado_search', $editor, $this->dataset, $lookupDataset, 'id', 'estado', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddMultiEditColumn($editColumn);
        ...
        protected function AddInsertColumns(Grid $grid)
        {
            ...
            $lookupDataset->setOrderByField('identificacionFilial', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Id Filial', 'idFilial', 'idFilial_identificacionFilial', 'insert_ter1aliadonegocio_ter1cliente_idFilial_search', $editor, $this->dataset, $lookupDataset, 'id', 'identificacionFilial', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            ...
            $lookupDataset->setOrderByField('tipoCliente', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Id Tipo Cliente', 'idTipoCliente', 'idTipoCliente_tipoCliente', 'insert_ter1aliadonegocio_ter1cliente_idTipoCliente_search', $editor, $this->dataset, $lookupDataset, 'id', 'tipoCliente', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddInsertColumn($editColumn);
            ...
            $lookupDataset->setOrderByField('regimen', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Id Regimen', 'idRegimen', 'idRegimen_regimen', 'insert_ter1aliadonegocio_ter1cliente_idRegimen_search', $editor, $this->dataset, $lookupDataset, 'id', 'regimen', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddInsertColumn($editColumn);
            ...
            $lookupDataset->setOrderByField('idEmpleado', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Id Asesor Comercial', 'idAsesorComercial', 'idAsesorComercial_idEmpleado', 'insert_ter1aliadonegocio_ter1cliente_idAsesorComercial_search', $editor, $this->dataset, $lookupDataset, 'id', 'idEmpleado', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddInsertColumn($editColumn);
            ...
            $lookupDataset->setOrderByField('identificacionAliado', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Id Aliado Negocios', 'idAliadoNegocios', 'idAliadoNegocios_identificacionAliado', 'insert_ter1aliadonegocio_ter1cliente_idAliadoNegocios_search', $editor, $this->dataset, $lookupDataset, 'id', 'identificacionAliado', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddInsertColumn($editColumn);
            ...
            $lookupDataset->setOrderByField('estado', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Id Estado', 'idEstado', 'idEstado_estado', 'insert_ter1aliadonegocio_ter1cliente_idEstado_search', $editor, $this->dataset, $lookupDataset, 'id', 'estado', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddInsertColumn($editColumn);
        ...
        protected function doRegisterHandlers() {
            ...
            $lookupDataset->setOrderByField('identificacionFilial', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'insert_ter1aliadonegocio_ter1cliente_idFilial_search', 'id', 'identificacionFilial', null, 20);
            ...
            $lookupDataset->setOrderByField('tipoCliente', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'insert_ter1aliadonegocio_ter1cliente_idTipoCliente_search', 'id', 'tipoCliente', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('regimen', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'insert_ter1aliadonegocio_ter1cliente_idRegimen_search', 'id', 'regimen', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('idEmpleado', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'insert_ter1aliadonegocio_ter1cliente_idAsesorComercial_search', 'id', 'idEmpleado', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('identificacionAliado', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'insert_ter1aliadonegocio_ter1cliente_idAliadoNegocios_search', 'id', 'identificacionAliado', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('estado', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'insert_ter1aliadonegocio_ter1cliente_idEstado_search', 'id', 'estado', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('identificacionFilial', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'filter_builder_ter1aliadonegocio_ter1cliente_idFilial_search', 'id', 'identificacionFilial', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('tipoCliente', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'filter_builder_ter1aliadonegocio_ter1cliente_idTipoCliente_search', 'id', 'tipoCliente', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('regimen', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'filter_builder_ter1aliadonegocio_ter1cliente_idRegimen_search', 'id', 'regimen', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('idEmpleado', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'filter_builder_ter1aliadonegocio_ter1cliente_idAsesorComercial_search', 'id', 'idEmpleado', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('identificacionAliado', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'filter_builder_ter1aliadonegocio_ter1cliente_idAliadoNegocios_search', 'id', 'identificacionAliado', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('estado', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'filter_builder_ter1aliadonegocio_ter1cliente_idEstado_search', 'id', 'estado', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('identificacionFilial', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'edit_ter1aliadonegocio_ter1cliente_idFilial_search', 'id', 'identificacionFilial', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('tipoCliente', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'edit_ter1aliadonegocio_ter1cliente_idTipoCliente_search', 'id', 'tipoCliente', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('regimen', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'edit_ter1aliadonegocio_ter1cliente_idRegimen_search', 'id', 'regimen', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('idEmpleado', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'edit_ter1aliadonegocio_ter1cliente_idAsesorComercial_search', 'id', 'idEmpleado', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('identificacionAliado', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'edit_ter1aliadonegocio_ter1cliente_idAliadoNegocios_search', 'id', 'identificacionAliado', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('estado', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'edit_ter1aliadonegocio_ter1cliente_idEstado_search', 'id', 'estado', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('identificacionFilial', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'multi_edit_ter1aliadonegocio_ter1cliente_idFilial_search', 'id', 'identificacionFilial', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('tipoCliente', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'multi_edit_ter1aliadonegocio_ter1cliente_idTipoCliente_search', 'id', 'tipoCliente', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('regimen', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'multi_edit_ter1aliadonegocio_ter1cliente_idRegimen_search', 'id', 'regimen', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('idEmpleado', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'multi_edit_ter1aliadonegocio_ter1cliente_idAsesorComercial_search', 'id', 'idEmpleado', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('identificacionAliado', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'multi_edit_ter1aliadonegocio_ter1cliente_idAliadoNegocios_search', 'id', 'identificacionAliado', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('estado', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'multi_edit_ter1aliadonegocio_ter1cliente_idEstado_search', 'id', 'estado', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
        }
    ...
    class ter1aliadonegocioPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('Ter1aliadonegocio');
            $this->SetMenuLabel('&#x2714; ALIADO DE NEGOCIO');
        ...
        protected function getFiltersColumns()
        {
            return array(
                new FilterColumn($this->dataset, 'id', 'id', 'Id'),
                new FilterColumn($this->dataset, 'identificacionAliado', 'identificacionAliado', 'Identificacion Aliado'),
                new FilterColumn($this->dataset, 'dvAliado', 'dvAliado', 'Dv Aliado'),
                new FilterColumn($this->dataset, 'nombreAliado', 'nombreAliado', 'Nombre Aliado'),
                new FilterColumn($this->dataset, 'DescripcionNegociacion', 'DescripcionNegociacion', 'Descripcion Negociacion'),
                new FilterColumn($this->dataset, 'idAprobadoPor', 'idAprobadoPor', 'Id Aprobado Por'),
        ...
        protected function setupQuickFilter(QuickFilter $quickFilter, FixedKeysArray $columns)
        {
            $quickFilter
                ->addColumn($columns['id'])
                ->addColumn($columns['identificacionAliado'])
                ->addColumn($columns['dvAliado'])
                ->addColumn($columns['nombreAliado'])
                ->addColumn($columns['DescripcionNegociacion'])
                ->addColumn($columns['idAprobadoPor'])
        ...
        protected function setupFilterBuilder(FilterBuilder $filterBuilder, FixedKeysArray $columns)
        {
            ...
            $main_editor = new TextEdit('identificacionaliado_edit');
            
            $filterBuilder->addColumn(
                $columns['identificacionAliado'],
                array(
                    FilterConditionOperator::EQUALS => $main_editor,
                    FilterConditionOperator::DOES_NOT_EQUAL => $main_editor,
                    FilterConditionOperator::IS_GREATER_THAN => $main_editor,
            ...
            $main_editor = new TextEdit('dvaliado_edit');
            ...
            $main_editor = new TextEdit('nombrealiado_edit');
            $main_editor->SetMaxLength(100);
            
            $filterBuilder->addColumn(
                $columns['nombreAliado'],
                array(
                    FilterConditionOperator::EQUALS => $main_editor,
                    FilterConditionOperator::DOES_NOT_EQUAL => $main_editor,
                    FilterConditionOperator::IS_GREATER_THAN => $main_editor,
            ...
            $main_editor = new TextEdit('DescripcionNegociacion');
            
            $filterBuilder->addColumn(
                $columns['DescripcionNegociacion'],
                array(
                    FilterConditionOperator::EQUALS => $main_editor,
                    FilterConditionOperator::DOES_NOT_EQUAL => $main_editor,
                    FilterConditionOperator::IS_GREATER_THAN => $main_editor,
            ...
            $main_editor = new TextEdit('idaprobadopor_edit');
            
            $filterBuilder->addColumn(
                $columns['idAprobadoPor'],
                array(
                    FilterConditionOperator::EQUALS => $main_editor,
                    FilterConditionOperator::DOES_NOT_EQUAL => $main_editor,
                    FilterConditionOperator::IS_GREATER_THAN => $main_editor,
        ...
        protected function AddFieldColumns(Grid $grid, $withDetails = true)
        {
            if (GetCurrentUserPermissionsForPage('ter1aliadonegocio.ter1cliente')->HasViewGrant() && $withDetails)
            {
            //
            // View column for ter1aliadonegocio_ter1cliente detail
            //
            $column = new DetailColumn(array('id'), 'ter1aliadonegocio.ter1cliente', 'ter1aliadonegocio_ter1cliente_handler', $this->dataset, 'Ter1cliente');
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            $grid->AddViewColumn($column);
            }
            ...
            // View column for identificacionAliado field
            //
            $column = new NumberViewColumn('identificacionAliado', 'identificacionAliado', 'Identificacion Aliado', $this->dataset);
            $column->SetOrderable(true);
            $column->setNumberAfterDecimal(0);
            $column->setThousandsSeparator(',');
            $column->setDecimalSeparator('');
            ...
            $grid->AddViewColumn($column);
            //
            // View column for dvAliado field
            //
            $column = new NumberViewColumn('dvAliado', 'dvAliado', 'Dv Aliado', $this->dataset);
            $column->SetOrderable(true);
            $column->setNumberAfterDecimal(0);
            $column->setThousandsSeparator(',');
            $column->setDecimalSeparator('');
            ...
            $grid->AddViewColumn($column);
            //
            // View column for nombreAliado field
            //
            $column = new TextViewColumn('nombreAliado', 'nombreAliado', 'Nombre Aliado', $this->dataset);
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            $grid->AddViewColumn($column);
            //
            // View column for DescripcionNegociacion field
            //
            $column = new TextViewColumn('DescripcionNegociacion', 'DescripcionNegociacion', 'Descripcion Negociacion', $this->dataset);
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            $grid->AddViewColumn($column);
            //
            // View column for idAprobadoPor field
            //
            $column = new NumberViewColumn('idAprobadoPor', 'idAprobadoPor', 'Id Aprobado Por', $this->dataset);
            $column->SetOrderable(true);
            $column->setNumberAfterDecimal(0);
            $column->setThousandsSeparator(',');
            $column->setDecimalSeparator('');
        ...
        {
            //
            // Edit column for identificacionAliado field
            //
            $editor = new TextEdit('identificacionaliado_edit');
            $editColumn = new CustomEditColumn('Identificacion Aliado', 'identificacionAliado', $editor, $this->dataset);
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            ...
            //
            // Edit column for dvAliado field
            //
            $editor = new TextEdit('dvaliado_edit');
            $editColumn = new CustomEditColumn('Dv Aliado', 'dvAliado', $editor, $this->dataset);
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            ...
            //
            // Edit column for nombreAliado field
            //
            $editor = new TextEdit('nombrealiado_edit');
            $editor->SetMaxLength(100);
            $editColumn = new CustomEditColumn('Nombre Aliado', 'nombreAliado', $editor, $this->dataset);
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            ...
            //
            // Edit column for DescripcionNegociacion field
            //
            $editor = new TextAreaEdit('descripcionnegociacion_edit', 50, 8);
            $editColumn = new CustomEditColumn('Descripcion Negociacion', 'DescripcionNegociacion', $editor, $this->dataset);
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            ...
            //
            // Edit column for idAprobadoPor field
            //
            $editor = new TextEdit('idaprobadopor_edit');
            $editColumn = new CustomEditColumn('Id Aprobado Por', 'idAprobadoPor', $editor, $this->dataset);
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
        ...
        protected function doRegisterHandlers() {
            $detailPage = new ter1aliadonegocio_ter1clientePage('ter1aliadonegocio_ter1cliente', $this, array('idAliadoNegocios'), array('id'), $this->GetForeignKeyFields(), $this->CreateMasterDetailRecordGrid(), $this->dataset, GetCurrentUserPermissionsForPage('ter1aliadonegocio.ter1cliente'), 'UTF-8');
            $detailPage->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource('ter1aliadonegocio.ter1cliente'));
            $detailPage->SetHttpHandlerName('ter1aliadonegocio_ter1cliente_handler');
            $handler = new PageHTTPHandler('ter1aliadonegocio_ter1cliente_handler', $detailPage);
            GetApplication()->RegisterHTTPHandler($handler);
    ...
    try
    {
        $Page = new ter1aliadonegocioPage("ter1aliadonegocio", "ter1aliadonegocio.php", GetCurrentUserPermissionsForPage("ter1aliadonegocio"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("ter1aliadonegocio"));

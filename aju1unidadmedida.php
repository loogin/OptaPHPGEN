 ...
 */
    ...
    class aju1unidadmedida_negserviciosPage extends DetailPage
    {
        ...
        protected function setupFilterBuilder(FilterBuilder $filterBuilder, FixedKeysArray $columns)
        {
            ...
            $main_editor->SetHandlerName('filter_builder_aju1unidadmedida_negservicios_idCat_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('idCat', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_aju1unidadmedida_negservicios_idCat_search');
            ...
            $main_editor->setMinimumInputLength(0);
            $main_editor->SetAllowNullValue(false);
            $main_editor->SetHandlerName('filter_builder_aju1unidadmedida_negservicios_idGrupoInventario_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('idGrupoInventario', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_aju1unidadmedida_negservicios_idGrupoInventario_search');
            ...
            $main_editor->setMinimumInputLength(0);
            $main_editor->SetAllowNullValue(false);
            $main_editor->SetHandlerName('filter_builder_aju1unidadmedida_negservicios_idimpuesto_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('idimpuesto', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_aju1unidadmedida_negservicios_idimpuesto_search');
            ...
            $main_editor->setMinimumInputLength(0);
            $main_editor->SetAllowNullValue(false);
            $main_editor->SetHandlerName('filter_builder_aju1unidadmedida_negservicios_idUnidadMedida_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('idUnidadMedida', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_aju1unidadmedida_negservicios_idUnidadMedida_search');
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            $editColumn = new DynamicLookupEditColumn('Id Cat', 'idCat', 'idCat_nombreCatalogo', 'edit_aju1unidadmedida_negservicios_idCat_search', $editor, $this->dataset, $lookupDataset, 'id', 'nombreCatalogo', '');
            ...
            $editColumn = new DynamicLookupEditColumn('Id Grupo Inventario', 'idGrupoInventario', 'idGrupoInventario_grupoInventarios', 'edit_aju1unidadmedida_negservicios_idGrupoInventario_search', $editor, $this->dataset, $lookupDataset, 'id', 'grupoInventarios', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            ...
            $editColumn = new DynamicLookupEditColumn('Idimpuesto', 'idimpuesto', 'idimpuesto_nombreImpuesto', 'edit_aju1unidadmedida_negservicios_idimpuesto_search', $editor, $this->dataset, $lookupDataset, 'id', 'nombreImpuesto', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            ...
            $editColumn = new DynamicLookupEditColumn('Id Unidad Medida', 'idUnidadMedida', 'idUnidadMedida_unidadMedida', 'edit_aju1unidadmedida_negservicios_idUnidadMedida_search', $editor, $this->dataset, $lookupDataset, 'id', 'unidadMedida', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
        ...
        protected function AddMultiEditColumns(Grid $grid)
        {
            ...
            $lookupDataset->setOrderByField('nombreCatalogo', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Id Cat', 'idCat', 'idCat_nombreCatalogo', 'multi_edit_aju1unidadmedida_negservicios_idCat_search', $editor, $this->dataset, $lookupDataset, 'id', 'nombreCatalogo', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            ...
            $lookupDataset->setOrderByField('grupoInventarios', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Id Grupo Inventario', 'idGrupoInventario', 'idGrupoInventario_grupoInventarios', 'multi_edit_aju1unidadmedida_negservicios_idGrupoInventario_search', $editor, $this->dataset, $lookupDataset, 'id', 'grupoInventarios', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddMultiEditColumn($editColumn);
            ...
            $lookupDataset->setOrderByField('nombreImpuesto', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Idimpuesto', 'idimpuesto', 'idimpuesto_nombreImpuesto', 'multi_edit_aju1unidadmedida_negservicios_idimpuesto_search', $editor, $this->dataset, $lookupDataset, 'id', 'nombreImpuesto', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddMultiEditColumn($editColumn);
            ...
            $lookupDataset->setOrderByField('unidadMedida', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Id Unidad Medida', 'idUnidadMedida', 'idUnidadMedida_unidadMedida', 'multi_edit_aju1unidadmedida_negservicios_idUnidadMedida_search', $editor, $this->dataset, $lookupDataset, 'id', 'unidadMedida', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddMultiEditColumn($editColumn);
        ...
        protected function AddInsertColumns(Grid $grid)
        {
            ...
            $lookupDataset->setOrderByField('nombreCatalogo', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Id Cat', 'idCat', 'idCat_nombreCatalogo', 'insert_aju1unidadmedida_negservicios_idCat_search', $editor, $this->dataset, $lookupDataset, 'id', 'nombreCatalogo', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            ...
            $lookupDataset->setOrderByField('grupoInventarios', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Id Grupo Inventario', 'idGrupoInventario', 'idGrupoInventario_grupoInventarios', 'insert_aju1unidadmedida_negservicios_idGrupoInventario_search', $editor, $this->dataset, $lookupDataset, 'id', 'grupoInventarios', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddInsertColumn($editColumn);
            ...
            $lookupDataset->setOrderByField('nombreImpuesto', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Idimpuesto', 'idimpuesto', 'idimpuesto_nombreImpuesto', 'insert_aju1unidadmedida_negservicios_idimpuesto_search', $editor, $this->dataset, $lookupDataset, 'id', 'nombreImpuesto', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddInsertColumn($editColumn);
            ...
            $lookupDataset->setOrderByField('unidadMedida', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Id Unidad Medida', 'idUnidadMedida', 'idUnidadMedida_unidadMedida', 'insert_aju1unidadmedida_negservicios_idUnidadMedida_search', $editor, $this->dataset, $lookupDataset, 'id', 'unidadMedida', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddInsertColumn($editColumn);
        ...
        protected function doRegisterHandlers() {
            ...
            $lookupDataset->setOrderByField('nombreCatalogo', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'insert_aju1unidadmedida_negservicios_idCat_search', 'id', 'nombreCatalogo', null, 20);
            ...
            $lookupDataset->setOrderByField('grupoInventarios', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'insert_aju1unidadmedida_negservicios_idGrupoInventario_search', 'id', 'grupoInventarios', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('nombreImpuesto', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'insert_aju1unidadmedida_negservicios_idimpuesto_search', 'id', 'nombreImpuesto', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('unidadMedida', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'insert_aju1unidadmedida_negservicios_idUnidadMedida_search', 'id', 'unidadMedida', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('nombreCatalogo', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'filter_builder_aju1unidadmedida_negservicios_idCat_search', 'id', 'nombreCatalogo', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('grupoInventarios', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'filter_builder_aju1unidadmedida_negservicios_idGrupoInventario_search', 'id', 'grupoInventarios', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('nombreImpuesto', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'filter_builder_aju1unidadmedida_negservicios_idimpuesto_search', 'id', 'nombreImpuesto', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('unidadMedida', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'filter_builder_aju1unidadmedida_negservicios_idUnidadMedida_search', 'id', 'unidadMedida', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('nombreCatalogo', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'edit_aju1unidadmedida_negservicios_idCat_search', 'id', 'nombreCatalogo', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('grupoInventarios', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'edit_aju1unidadmedida_negservicios_idGrupoInventario_search', 'id', 'grupoInventarios', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('nombreImpuesto', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'edit_aju1unidadmedida_negservicios_idimpuesto_search', 'id', 'nombreImpuesto', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('unidadMedida', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'edit_aju1unidadmedida_negservicios_idUnidadMedida_search', 'id', 'unidadMedida', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('nombreCatalogo', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'multi_edit_aju1unidadmedida_negservicios_idCat_search', 'id', 'nombreCatalogo', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('grupoInventarios', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'multi_edit_aju1unidadmedida_negservicios_idGrupoInventario_search', 'id', 'grupoInventarios', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('nombreImpuesto', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'multi_edit_aju1unidadmedida_negservicios_idimpuesto_search', 'id', 'nombreImpuesto', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('unidadMedida', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'multi_edit_aju1unidadmedida_negservicios_idUnidadMedida_search', 'id', 'unidadMedida', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
        }
    ...
    class aju1unidadmedidaPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('Aju1unidadmedida');
            $this->SetMenuLabel('Aju1unidadmedida');
        ...
        protected function getFiltersColumns()
        {
            return array(
                new FilterColumn($this->dataset, 'id', 'id', 'Id'),
                new FilterColumn($this->dataset, 'unidadMedida', 'unidadMedida', 'Unidad Medida'),
                new FilterColumn($this->dataset, 'usuarioRegistra', 'usuarioRegistra', 'Usuario Registra'),
                new FilterColumn($this->dataset, 'fechaRegistra', 'fechaRegistra', 'Fecha Registra')
            );
        }
        ...
        protected function setupQuickFilter(QuickFilter $quickFilter, FixedKeysArray $columns)
        {
            $quickFilter
                ->addColumn($columns['id'])
                ->addColumn($columns['unidadMedida'])
                ->addColumn($columns['usuarioRegistra'])
                ->addColumn($columns['fechaRegistra']);
        }
        ...
        protected function setupFilterBuilder(FilterBuilder $filterBuilder, FixedKeysArray $columns)
        {
            ...
            $main_editor = new TextEdit('unidadmedida_edit');
            $main_editor->SetMaxLength(100);
            
            $filterBuilder->addColumn(
                $columns['unidadMedida'],
                array(
                    FilterConditionOperator::EQUALS => $main_editor,
                    FilterConditionOperator::DOES_NOT_EQUAL => $main_editor,
                    FilterConditionOperator::IS_GREATER_THAN => $main_editor,
        ...
        protected function AddFieldColumns(Grid $grid, $withDetails = true)
        {
            if (GetCurrentUserPermissionsForPage('aju1unidadmedida.negservicios')->HasViewGrant() && $withDetails)
            {
            //
            // View column for aju1unidadmedida_negservicios detail
            //
            $column = new DetailColumn(array('id'), 'aju1unidadmedida.negservicios', 'aju1unidadmedida_negservicios_handler', $this->dataset, 'Negservicios');
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            $grid->AddViewColumn($column);
            }
            ...
            // View column for unidadMedida field
            //
            $column = new TextViewColumn('unidadMedida', 'unidadMedida', 'Unidad Medida', $this->dataset);
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            $grid->AddViewColumn($column);
        ...
        {
            //
            // Edit column for unidadMedida field
            //
            $editor = new TextEdit('unidadmedida_edit');
            $editor->SetMaxLength(100);
            $editColumn = new CustomEditColumn('Unidad Medida', 'unidadMedida', $editor, $this->dataset);
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
        ...
        protected function doRegisterHandlers() {
            $detailPage = new aju1unidadmedida_negserviciosPage('aju1unidadmedida_negservicios', $this, array('idUnidadMedida'), array('id'), $this->GetForeignKeyFields(), $this->CreateMasterDetailRecordGrid(), $this->dataset, GetCurrentUserPermissionsForPage('aju1unidadmedida.negservicios'), 'UTF-8');
            $detailPage->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource('aju1unidadmedida.negservicios'));
            $detailPage->SetHttpHandlerName('aju1unidadmedida_negservicios_handler');
            $handler = new PageHTTPHandler('aju1unidadmedida_negservicios_handler', $detailPage);
            GetApplication()->RegisterHTTPHandler($handler);
    ...
    try
    {
        $Page = new aju1unidadmedidaPage("aju1unidadmedida", "aju1unidadmedida.php", GetCurrentUserPermissionsForPage("aju1unidadmedida"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("aju1unidadmedida"));

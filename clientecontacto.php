 ...
 */
    ...
    class clientecontactoPage extends Page
    {
        ...
        protected function setupFilterBuilder(FilterBuilder $filterBuilder, FixedKeysArray $columns)
        {
            ...
            $main_editor->SetHandlerName('filter_builder_clientecontacto_idCliente_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('idCliente', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_clientecontacto_idCliente_search');
            ...
            $main_editor->setMinimumInputLength(0);
            $main_editor->SetAllowNullValue(false);
            $main_editor->SetHandlerName('filter_builder_clientecontacto_idClienteSucursal_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('idClienteSucursal', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_clientecontacto_idClienteSucursal_search');
            ...
            $main_editor->setMinimumInputLength(0);
            $main_editor->SetAllowNullValue(false);
            $main_editor->SetHandlerName('filter_builder_clientecontacto_idGrupoNotificacion_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('idGrupoNotificacion', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_clientecontacto_idGrupoNotificacion_search');
            ...
            $main_editor->setMinimumInputLength(0);
            $main_editor->SetAllowNullValue(false);
            $main_editor->SetHandlerName('filter_builder_clientecontacto_idEstado_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('idEstado', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_clientecontacto_idEstado_search');
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            $editColumn = new DynamicLookupEditColumn('Id Cliente', 'idCliente', 'idCliente_idFilial', 'edit_clientecontacto_idCliente_search', $editor, $this->dataset, $lookupDataset, 'id', 'idFilial', '');
            ...
            $editColumn = new DynamicLookupEditColumn('Id Cliente Sucursal', 'idClienteSucursal', 'idClienteSucursal_idCliente', 'edit_clientecontacto_idClienteSucursal_search', $editor, $this->dataset, $lookupDataset, 'id', 'idCliente', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            ...
            $editColumn = new DynamicLookupEditColumn('Id Grupo Notificacion', 'idGrupoNotificacion', 'idGrupoNotificacion_grupoNegociacion', 'edit_clientecontacto_idGrupoNotificacion_search', $editor, $this->dataset, $lookupDataset, 'id', 'grupoNegociacion', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            ...
            $editColumn = new DynamicLookupEditColumn('Id Estado', 'idEstado', 'idEstado_estado', 'edit_clientecontacto_idEstado_search', $editor, $this->dataset, $lookupDataset, 'id', 'estado', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
        ...
        protected function AddMultiEditColumns(Grid $grid)
        {
            ...
            $lookupDataset->setOrderByField('idFilial', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Id Cliente', 'idCliente', 'idCliente_idFilial', 'multi_edit_clientecontacto_idCliente_search', $editor, $this->dataset, $lookupDataset, 'id', 'idFilial', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            ...
            $lookupDataset->setOrderByField('idCliente', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Id Cliente Sucursal', 'idClienteSucursal', 'idClienteSucursal_idCliente', 'multi_edit_clientecontacto_idClienteSucursal_search', $editor, $this->dataset, $lookupDataset, 'id', 'idCliente', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddMultiEditColumn($editColumn);
            ...
            $lookupDataset->setOrderByField('grupoNegociacion', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Id Grupo Notificacion', 'idGrupoNotificacion', 'idGrupoNotificacion_grupoNegociacion', 'multi_edit_clientecontacto_idGrupoNotificacion_search', $editor, $this->dataset, $lookupDataset, 'id', 'grupoNegociacion', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddMultiEditColumn($editColumn);
            ...
            $lookupDataset->setOrderByField('estado', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Id Estado', 'idEstado', 'idEstado_estado', 'multi_edit_clientecontacto_idEstado_search', $editor, $this->dataset, $lookupDataset, 'id', 'estado', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddMultiEditColumn($editColumn);
        ...
        protected function AddInsertColumns(Grid $grid)
        {
            ...
            $lookupDataset->setOrderByField('idFilial', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Id Cliente', 'idCliente', 'idCliente_idFilial', 'insert_clientecontacto_idCliente_search', $editor, $this->dataset, $lookupDataset, 'id', 'idFilial', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            ...
            $lookupDataset->setOrderByField('idCliente', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Id Cliente Sucursal', 'idClienteSucursal', 'idClienteSucursal_idCliente', 'insert_clientecontacto_idClienteSucursal_search', $editor, $this->dataset, $lookupDataset, 'id', 'idCliente', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddInsertColumn($editColumn);
            ...
            $lookupDataset->setOrderByField('grupoNegociacion', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Id Grupo Notificacion', 'idGrupoNotificacion', 'idGrupoNotificacion_grupoNegociacion', 'insert_clientecontacto_idGrupoNotificacion_search', $editor, $this->dataset, $lookupDataset, 'id', 'grupoNegociacion', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddInsertColumn($editColumn);
            ...
            $lookupDataset->setOrderByField('estado', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Id Estado', 'idEstado', 'idEstado_estado', 'insert_clientecontacto_idEstado_search', $editor, $this->dataset, $lookupDataset, 'id', 'estado', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddInsertColumn($editColumn);
        ...
        protected function doRegisterHandlers() {
            ...
            $lookupDataset->setOrderByField('idFilial', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'insert_clientecontacto_idCliente_search', 'id', 'idFilial', null, 20);
            ...
            $lookupDataset->setOrderByField('idCliente', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'insert_clientecontacto_idClienteSucursal_search', 'id', 'idCliente', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('grupoNegociacion', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'insert_clientecontacto_idGrupoNotificacion_search', 'id', 'grupoNegociacion', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('estado', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'insert_clientecontacto_idEstado_search', 'id', 'estado', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('idFilial', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'filter_builder_clientecontacto_idCliente_search', 'id', 'idFilial', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('idCliente', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'filter_builder_clientecontacto_idClienteSucursal_search', 'id', 'idCliente', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('grupoNegociacion', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'filter_builder_clientecontacto_idGrupoNotificacion_search', 'id', 'grupoNegociacion', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('estado', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'filter_builder_clientecontacto_idEstado_search', 'id', 'estado', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('idFilial', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'edit_clientecontacto_idCliente_search', 'id', 'idFilial', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('idCliente', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'edit_clientecontacto_idClienteSucursal_search', 'id', 'idCliente', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('grupoNegociacion', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'edit_clientecontacto_idGrupoNotificacion_search', 'id', 'grupoNegociacion', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('estado', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'edit_clientecontacto_idEstado_search', 'id', 'estado', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('idFilial', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'multi_edit_clientecontacto_idCliente_search', 'id', 'idFilial', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('idCliente', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'multi_edit_clientecontacto_idClienteSucursal_search', 'id', 'idCliente', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('grupoNegociacion', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'multi_edit_clientecontacto_idGrupoNotificacion_search', 'id', 'grupoNegociacion', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('estado', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'multi_edit_clientecontacto_idEstado_search', 'id', 'estado', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
        }
    ...
    try
    {
        $Page = new clientecontactoPage("clientecontacto", "clientecontacto.php", GetCurrentUserPermissionsForPage("clientecontacto"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("clientecontacto"));

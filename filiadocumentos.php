 ...
 */
    ...
    class filiadocumentosPage extends Page
    {
        ...
        protected function setupFilterBuilder(FilterBuilder $filterBuilder, FixedKeysArray $columns)
        {
            ...
            $main_editor->SetHandlerName('filter_builder_filiadocumentos_idFilial_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('idFilial', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_filiadocumentos_idFilial_search');
            ...
            $main_editor->setMinimumInputLength(0);
            $main_editor->SetAllowNullValue(false);
            $main_editor->SetHandlerName('filter_builder_filiadocumentos_idTipoDocumento_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('idTipoDocumento', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_filiadocumentos_idTipoDocumento_search');
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            $editColumn = new DynamicLookupEditColumn('Id Filial', 'idFilial', 'idFilial_identificacionFilial', 'edit_filiadocumentos_idFilial_search', $editor, $this->dataset, $lookupDataset, 'id', 'identificacionFilial', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            ...
            $editColumn = new DynamicLookupEditColumn('Id Tipo Documento', 'idTipoDocumento', 'idTipoDocumento_tipoDocumento', 'edit_filiadocumentos_idTipoDocumento_search', $editor, $this->dataset, $lookupDataset, 'id', 'tipoDocumento', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
        ...
        protected function AddMultiEditColumns(Grid $grid)
        {
            ...
            $lookupDataset->setOrderByField('identificacionFilial', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Id Filial', 'idFilial', 'idFilial_identificacionFilial', 'multi_edit_filiadocumentos_idFilial_search', $editor, $this->dataset, $lookupDataset, 'id', 'identificacionFilial', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddMultiEditColumn($editColumn);
            ...
            $lookupDataset->setOrderByField('tipoDocumento', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Id Tipo Documento', 'idTipoDocumento', 'idTipoDocumento_tipoDocumento', 'multi_edit_filiadocumentos_idTipoDocumento_search', $editor, $this->dataset, $lookupDataset, 'id', 'tipoDocumento', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddMultiEditColumn($editColumn);
        ...
        protected function AddInsertColumns(Grid $grid)
        {
            ...
            $lookupDataset->setOrderByField('identificacionFilial', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Id Filial', 'idFilial', 'idFilial_identificacionFilial', 'insert_filiadocumentos_idFilial_search', $editor, $this->dataset, $lookupDataset, 'id', 'identificacionFilial', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddInsertColumn($editColumn);
            ...
            $lookupDataset->setOrderByField('tipoDocumento', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Id Tipo Documento', 'idTipoDocumento', 'idTipoDocumento_tipoDocumento', 'insert_filiadocumentos_idTipoDocumento_search', $editor, $this->dataset, $lookupDataset, 'id', 'tipoDocumento', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddInsertColumn($editColumn);
        ...
        protected function doRegisterHandlers() {
            ...
            $lookupDataset->setOrderByField('identificacionFilial', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'insert_filiadocumentos_idFilial_search', 'id', 'identificacionFilial', null, 20);
            ...
            $lookupDataset->setOrderByField('tipoDocumento', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'insert_filiadocumentos_idTipoDocumento_search', 'id', 'tipoDocumento', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('identificacionFilial', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'filter_builder_filiadocumentos_idFilial_search', 'id', 'identificacionFilial', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('tipoDocumento', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'filter_builder_filiadocumentos_idTipoDocumento_search', 'id', 'tipoDocumento', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('identificacionFilial', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'edit_filiadocumentos_idFilial_search', 'id', 'identificacionFilial', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('tipoDocumento', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'edit_filiadocumentos_idTipoDocumento_search', 'id', 'tipoDocumento', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('identificacionFilial', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'multi_edit_filiadocumentos_idFilial_search', 'id', 'identificacionFilial', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('tipoDocumento', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'multi_edit_filiadocumentos_idTipoDocumento_search', 'id', 'tipoDocumento', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
        }
    ...
    try
    {
        $Page = new filiadocumentosPage("filiadocumentos", "filiadocumentos.php", GetCurrentUserPermissionsForPage("filiadocumentos"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("filiadocumentos"));

 ...
 */
    ...
    class aju1estadoPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('Aju1estado');
            $this->SetMenuLabel('Aju1estado');
    ...
    try
    {
        $Page = new aju1estadoPage("aju1estado", "aju1estado.php", GetCurrentUserPermissionsForPage("aju1estado"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("aju1estado"));
